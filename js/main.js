(function () {
  const header = `<header id="navbar" class="fixed inset-x-0 top-0 z-50 transition-all duration-500"><div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-12"><a href="index.html" class="text-sm font-semibold tracking-[-.04em]">Praise Franks<span class="text-zinc-400">®</span></a><nav class="hidden items-center gap-8 md:flex"><a class="nav-link" href="index.html">Home</a><a class="nav-link" href="about.html">About</a><a class="nav-link" href="contact.html">Contact</a><button class="theme-button" data-theme-toggle aria-label="Toggle theme"><span data-theme-icon>☾</span></button></nav><div class="flex items-center gap-3 md:hidden"><button class="theme-button" data-theme-toggle aria-label="Toggle theme"><span data-theme-icon>☾</span></button><button id="menu-button" class="menu-button" aria-label="Open menu" aria-expanded="false"><span></span><span></span></button></div></div></header><div id="mobile-menu" class="fixed inset-0 z-40 invisible"><div id="menu-overlay" class="absolute inset-0 bg-black/30 opacity-0"></div><aside class="absolute right-0 top-0 h-full w-[min(86vw,20rem)] max-w-sm translate-x-full bg-white p-8 pt-28 dark:bg-[#111114]"><p class="eyebrow">Menu</p><nav class="mt-10 grid gap-6 text-3xl tracking-[-.05em]"><a href="index.html">Home</a><a href="about.html">About</a><a href="contact.html">Contact</a></nav><div class="mt-16 border-t border-zinc-200 pt-6 dark:border-zinc-800"><p class="eyebrow mb-5">Elsewhere</p><div class="flex gap-4 text-xs text-zinc-500"><a href="https://instagram.com">Instagram</a><a href="https://youtube.com">YouTube</a><a href="https://tiktok.com">TikTok</a></div></div></aside></div>`;
